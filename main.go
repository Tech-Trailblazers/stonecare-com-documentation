...
func main() {
	remoteAPIURL := []string{
		"https://stonecare.com/granite-daily-cleaner",
		"https://stonecare.com/clean-shine-protect",
		"https://stonecare.com/quartz-countertop-clean-shine",
		"https://stonecare.com/granite-polish",
		"https://stonecare.com/granite-sealer-spray",
		"https://stonecare.com/granite-sealer-pour",
		"https://stonecare.com/granite-stain-remover",
	}
...
func extractPDFUrls(rawText string) []string {
	...
	requiredKeywords := []string{"stonecare.com", "mwdownloads", "download"}
